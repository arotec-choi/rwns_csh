...
public class testVO {
	...
	public String toString() {
		return "testVO [recid=" + recid + ", FLOWMTR_ID=" + FLOWMTR_ID + ", NAME=" + NAME + ", INST_DATE=" + INST_DATE
				+ ", FMETE_FORM=" + FMETE_FORM + ", FMETE_TYPE=" + FMETE_TYPE + ", WTRSYS=" + WTRSYS + ", AUTO_TYPE="
				+ AUTO_TYPE + ", PIPE_DIA=" + PIPE_DIA + ", PIPE_ID=" + PIPE_ID + ", IN_AREA=" + IN_AREA + ", OUT_AREA="
				+ OUT_AREA + ", ADDR=" + ADDR + ", REMARK=" + REMARK + ", SBLOCK_ID=" + SBLOCK_ID + ", OFFICE_ID="
				+ OFFICE_ID + ", STD_WHMR_V=" + STD_WHMR_V + ", FAC_NAME=" + FAC_NAME + ", DATA_TYPE=" + DATA_TYPE
				+ ", OUT_ZONE=" + OUT_ZONE + ", FLSY_NAME=" + FLSY_NAME + ", GIS_CODE=" + GIS_CODE + ", TSMTR_DATE="
				+ TSMTR_DATE + ", OFFICE=" + OFFICE + ", J_BLOCK=" + J_BLOCK + ", S_BLOCK=" + S_BLOCK + ", STD_WHMR="
				+ STD_WHMR + ", USE_CLA=" + USE_CLA + ", REP_CHK=" + REP_CHK + ", CMC_ERR_VALUE=" + CMC_ERR_VALUE + "]";
	}
